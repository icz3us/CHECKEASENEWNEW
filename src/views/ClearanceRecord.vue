<template>
  <div class="container-fluid">
    ...
    <!-- Add Student Dialog -->
    <div v-if="showAddStudentDialog" class="modal-overlay offset-md-1">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form @submit.prevent="addStudent">
              ...
              <button type="button" class="btn btn-secondary me-2" @click="showAddStudentDialog = false">Close</button>
            </form>
          </div>
        </div>
      </div>
  ...
  data() {
    return {
      ...
      allStudents: [
        ...
        { lastName: 'Brown', firstName: 'Emily', studentNumber: 'ST005', email: 'emily.brown@example.com' } 
      ],
